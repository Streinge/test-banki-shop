...
<table class="table">
    <thead>
        <tr>
            <th>
                <p>Имя файла</p>
                <a href="{{ route('images', ['filename', 'asc']) }}"><img style="margin-left: 10px; margin-right: 10px" src="/icons/asc26.png"></a>
                <a href="{{ route('images', ['filename', 'desc']) }}"><img style="margin-left: 10px; margin-right: 10px" src="/icons/desc26.png"></a>
            </th>
            <th>
                <p>Дата создания</p>
